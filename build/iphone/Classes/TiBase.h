...
// in simulator we redefine to format for POC Developer console
...
{\
	NSString * exceptionName = [@"org.poc." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.poc";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIPOCNativeItemNone = -1, 
	UIPOCNativeItemSpinner = -2,
	UIPOCNativeItemProgressBar = -3,
	
	UIPOCNativeItemSlider = -4,
	UIPOCNativeItemSwitch = -5,
	UIPOCNativeItemMultiButton = -6,
	UIPOCNativeItemSegmented = -7,
	
	UIPOCNativeItemTextView = -8,
	UIPOCNativeItemTextField = -9,
	UIPOCNativeItemSearchBar = -10,
	
	UIPOCNativeItemPicker = -11,
	UIPOCNativeItemDatePicker = -12,
	
	UIPOCNativeItemInfoLight = -13,
	UIPOCNativeItemInfoDark = -14,
	
	UIPOCNativeItemDisclosure = -15,
	
	UIPOCNativeItemContactAdd = -16
};
